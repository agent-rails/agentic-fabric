...
- Claude Code enforces this by construction — subagents can't spawn subagents — so the router-persona / deep-tree anti-patterns can't be built. See [ADR-0002](decisions/0002-user-is-orchestrator.md).
