...
- At the source-read boundary: missing source file or unreadable path -> halt
  ...
  your-triage-agent log, your-pr-reviewer log, skills dir, agents dir.
- At the output-write boundary: output files at `~/your-triage-agent/wiki/recurring/`
...
`~/your-triage-agent/scripts/log-skill-invocation.sh` appends one JSON line per
invocation to `~/your-triage-agent/wiki/recurring/.invocations.jsonl`:
...
`~/your-triage-agent/wiki/recurring/orchestration.md` mapping the skill to its
