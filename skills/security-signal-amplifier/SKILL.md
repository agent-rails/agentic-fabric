...
- Wiki log entry appended to `~/your-triage-agent/wiki/log.md` via your-triage-scribe with the advisory, destinations, and resolved actions.
...
- Wiki logging delegated to your-triage-scribe; this skill returns the post permalinks and lets the scribe handle persistence.
